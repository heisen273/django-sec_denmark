...
class XBRL:
        ...
        if opener:
            ...
            for item in lst:
                ...
                for element in c:
                    ...
                    while str[0] == ' ':
                        str = str[1:]
                    self.tags.append(str.split(' ')[0][1:])
    ...
    def GetBaseInformation(self):
        ...
        except: oNode = self.getNode("//c:IdentificationNumberCvrOfReportingEntity[@contextRef]")
        ...
        except: oNode = self.getNode("//c:InformationOnTypeOfSubmittedReport[@contextRef]")
        if oNode is not None:
